                    ...
                    <form role="form" action="{{URL::to('/save-category-product')}}" method="post">
                        ...
                        <div class="form-group">
                            <label for="exampleInputPassword1">Mô tả danh
                                mục</label> <br>
                            <textarea style="width: 100%; height: 200px;" class="form￾control" name="category_product_desc" id="exampleInputPassword1"
                                placeholder="Mô tả danh mục"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Từ khóa danh
                                mục</label> <br>
                            <textarea style="width: 100%; height: 200px;" class="form￾control" name="category_product_keywords" id="exampleInputPassword1"
                                placeholder="Mô tả danh mục"></textarea>
                        </div>
                        <div class="form-group">
